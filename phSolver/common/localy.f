...
c
        ...
        subroutine localyc (global, rlocal, ientmp, n, code)
c
c----------------------------------------------------------------------
c
c This subroutine performs a vector gather/scatter operation.
...
!      Put u,v,w in the slots 2,3,4 of yl 
          ...
          do j = 1, 3
            do i = 1, nshl
              rlocal(1:npro,i,j+1) = global(ien(1:npro,i),j)
            enddo
          enddo
...
!      Put Pressure in the first slot of yl
          ...
          do i = 1, nshl
             rlocal(1:npro,i,1) = global(ien(1:npro,i),4)
          enddo
...
!      Fill in the remaining slots with T, and additional scalars
          ...
          if(n.gt.4) then
             do j = 5, n
                do i = 1, nshl
                   rlocal(1:npro,i,j) = global(ien(1:npro,i),j)
                enddo
             enddo
          endif
c
