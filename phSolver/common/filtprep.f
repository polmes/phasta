...
c     Come constants for clipping of cdelsq for the LES of the Boeing Bump
      parameter ( 
     &     a0        = 0.041510895320683d0,
     &     a1        = 0.011027853131711d0,
     &     b1        = 0.017377187577770d0,
     &     a2        = 0.022280444472914d0,
     &     b2        = -0.004186293823996d0,
     &     a3        = 0.005213351691937d0,
     &     b3        = 0.001551563962705d0,
     &     a4        = 0.007209590137928d0,
     &     b4        = 0.000521824246470d0,
     &     a5        = 0.000781385795916d0,
     &     b5        = -0.001410808337245d0,
     &     a6        = 0.001136457832955d0,
     &     b6        = -0.000046812320420d0,
     &     a7        = 0.000341605244512d0,
     &     b7        = -0.000787043335988d0,
     &     a8        = 0.000553559661377d0,
     &     b8        = -0.000125964552728d0,
     &     w         = 3.079864605938556d0 
     &     )
